<?php
    ...
    {
        Echo "<script Language = 'Javascript'> alert('As senhas não são iguais, tente novamente.'); window.location = 'AlterarSenhaUsuario.php'; </script>";
    }
    ...
    try
    {
        ...
        if($Resultado == true)
        {
            ...
            Echo "<script Language = 'Javascript'> alert('Alteração de senha concluída com sucesso! Por favor, guarde sua senha..'); window.location = 'LoginUsuario.php'; </script>";
