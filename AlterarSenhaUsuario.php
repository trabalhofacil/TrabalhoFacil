<?php
    ...
    $HashValidacao = str_replace("/TrabalhoFacil/AlterarSenhaUsuario.php?", "", $_SERVER["REQUEST_URI"]);
...
?>
        ...
        <div class = "container">
            ...
            <form action = "PostAlteracaoSenhaUsuario.php" method = "POST" style = "margin-top: 100px;">
