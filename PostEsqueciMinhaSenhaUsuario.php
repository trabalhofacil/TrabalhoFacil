<?php
    ...
    try
    {
        ...
        $Select = $Conexao->prepare("SELECT email FROM usuarios WHERE cpf = '$CPF'");
        $Select->execute();
        ...
        if($Resultado == true)
        {
            ...
            $Email->Body    = "127.0.0.1/TrabalhoFacil/AlterarSenhaUsuario.php?".$Codificacao;
            ...
            Echo "<script Language = 'Javascript'> window.location = 'EnvioEmailUsuario.php'; </script>";
        ...
        else if($Resultado == false)
        {
            ...
            Echo "<script Language = 'Javascript'> alert('CPF digitado não cadastrado.'); window.location = 'EsqueciMinhaSenhaUsuario.php'; </script>";
