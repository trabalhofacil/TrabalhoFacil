<?php
    ...
    try
    {
        ...
        $Select = $Conexao->prepare("SELECT foto FROM curriculo WHERE email = '$EmailPerfil'");
        $Select->execute();
        ...
        $Update = "UPDATE curriculo
                   ...
                   WHERE  email_perfil      = '$EmailPerfil'";    


        $Update = $Conexao->query($Update);

        Echo "<script Language = 'Javascript'> alert('Curriculo alterado com sucesso!'); window.location = 'PerfilUsuario.php'; </script>";
